...
GUI.name = "Lokasenna_GUI "..GUI.version.." Example"
GUI.x, GUI.y, GUI.w, GUI.h = -50, -50, 640, 480
...
--	name		= element type		x	 y    w    h	caption			...other params...
	...
	pan_sldr 	= GUI.Slider:new(	400, 200, 128, 		"Volume:", -12, 3, 40, 30, 0),
	vol_knb 	= GUI.Knob:new(		450, 300, 48,  		"Volume", 0, 5, 6, 5, 1),
	options 	= GUI.Radio:new(	50,  100, 150, 150, "Muppets:", "Cool,Dumb,Who?,Delicious", 4),
	range_sldr  = GUI.Range:new(	300, 50,  200, 		"Spread:", 0, 100, 101, 0, 101),
	...
	my_btn	 	= GUI.Button:new(	400, 100, 100, 50, 	"CLICK ME"),
